...
export default makeStyles(() => {
  return {
    ...
    account_details_container: {
      ...
      //   },
      //   ".checked": {
      //     boxShadow: "0 0 0 2px #fff, 0 0 0 4px #7f8c9f",
      //   },
      // },
    },
    select_root: {
    ...
    color_picker_button: {
      ...
      "&.custom": {
        ...
        backgroundImage: ({ conicalGradients }) => `url(${conicalGradients})`,
    ...
    logo_upload_button: {
      ...
      "& .MuiTypography-root.button-link": {
        display: "contents",
      },
    },
    // logo_image: {
    ...
    email_notifications_container: {
      ...
      borderRadius: 10,
      boxShadow: "2px 2px 0 rgb(0 27 64 / 10%)",
      width: 950,
      "& .header": {
        borderBottom: "1px solid #ccd1d9",
      },
    },
    settings_tab_footer: {
      // position: "sticky",
      ...
      "& .MuiButton-root": {
        ...
        borderRadius: 5,
        padding: "8px 16px",
        backgroundColor: "#37a703 !important",
        color: "#fff",
        "&:hover": {
          backgroundColor: "#348e09 !important",
        },
      },
    },
    // fullScreen_dialog: {
